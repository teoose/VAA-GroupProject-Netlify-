...
## 5. Anova Testing: Event Types & Fatatilites

The following code chunk below is used for Anova Testing of the types of events against the number of fatalities grouped by regions.
